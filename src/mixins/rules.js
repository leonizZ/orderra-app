    ...
    return {
      rules: {
        ...
        minAmountRule: value => {
          if (value)
            return (
              value >= window.SETTINGS.MIN_BET ||
              `Minimum amount is ${window.SETTINGS.MIN_BET}.00`
            );
          return "";
        },
        minWithdrawRule: value => {
          if (value)
            return (
              value >= window.SETTINGS.MIN_WITHDRAW ||
              `Minimum amount is ${window.SETTINGS.MIN_WITHDRAW}.00`
            );
          return "";
        },
        phone: value => {
